...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CBGgbHoh.js
var router_CBGgbHoh_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-D0P6jV-5.css";
var APP_NAME = "Gün Planı";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Plan your day with voice. Turkish and English."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-DQMuw57-.mjs");
...
//#endregion
export { getRouter, router_CBGgbHoh_exports as t };
