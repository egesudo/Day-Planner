...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-6WyVYgIP.mjs");
...
var manifest = { "f4d658f73b65785a6eff8561baaa81eb1a60566527f0d3cac653e7b09869002d": {
	functionName: "interpretSpeech_createServerFn_handler",
	importer: () => import("./interpret-speech-CP9-oMfx.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CBGgbHoh.mjs").then((n) => n.t),
